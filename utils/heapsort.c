...
void swap_heap_elements_int(size_t* arr, size_t a, size_t b) {
    size_t temp;
    temp = arr[a];
    arr[a] = arr[b];
    arr[b] = temp;
...
void min_heapify_int(size_t* arr, size_t n, size_t i) {
    size_t l, r, smallest;
    ...
    while(1) {
        ...
        if(smallest != i) {
            swap_heap_elements_int(arr, i, smallest);
            i = smallest;
        }
        else break;
    }
...
void build_min_heap_int(size_t* arr, size_t n) {
    for(size_t i = (n >> 1) - 1; i > 0; i--) min_heapify_int(arr, n, i);
    min_heapify_int(arr, n, 0);
}

void heapsort_int(size_t* arr, size_t n) {
    build_min_heap_int(arr, n);
    for(size_t i = n - 1; i > 0; i--) {
        swap_heap_elements_int(arr, i, 0);
        min_heapify_int(arr, i, 0);
    }
}
